...
// Rendelés részletek lekérdezése
if (isset($_GET['order_id'])) {
    try {
        // ... existing code ...
        
        if (!$order) {
            Notification::add('A rendelés nem található!', 'failure');
            header('Location: order_history.php');
            exit;
        }
    } catch (Exception $e) {
        Notification::add('Hiba történt a rendelés részleteinek lekérdezése során: ' . $e->getMessage(), 'failure');
    }
}
